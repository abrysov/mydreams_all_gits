//
//  PMPersonalListFulfilledDreams.m
//  MyDreams
//
...
@interface PMPersonalListFulfilledDreamsVC ()
@property (strong, nonatomic) PMPersonalListFulfilledDreamsLogic *logic;
...
@implementation PMPersonalListFulfilledDreamsVC
@dynamic logic;
