...
RSpec.describe Api::V1::LikesController, type: :controller do
  ...
  describe 'GET #index' do
    ...
    context 'when success find dream and likes' do
      ...
      let(:params) { { entity_id: dream.id, entity_type: 'dream', access_token: token } }
    ...
    context 'when failed find dream' do
      ...
      let(:params) { { entity_id: 1234, entity_type: 'dream', access_token: token } }
    ...
    context 'when success find post and likes' do
      ...
      let(:params) { { entity_id: test_post.id, entity_type: 'post', access_token: token } }
  ...
  describe 'delete #destroy' do
    ...
    let(:token) { Doorkeeper::AccessToken.create!(resource_owner_id: dreamer.id).token }
    let(:params) do
      { id: like.likeable.id, access_token: token,
        entity_type: like.likeable.class.to_s.underscore }
    end
