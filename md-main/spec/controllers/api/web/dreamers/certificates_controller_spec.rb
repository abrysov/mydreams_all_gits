...
RSpec.describe Api::Web::Dreamers::CertificatesController, type: :controller do
  ...
  describe 'GET #index' do
    ...
    context 'when get buyed certificates' do
      before { get :index, dreamer_id: dreamer.id, paid: true }
    ...
    context 'when get gifted certificates' do
      before { get :index, dreamer_id: dreamer.id, gifted: true }
    ...
    context 'when get certificates ordered by created date' do
      before { get :index, dreamer_id: dreamer.id, new: true }
    ...
    context 'when get certificates ordered by launches count(status)' do
      before { get :index, dreamer_id: dreamer.id, launches: true }
