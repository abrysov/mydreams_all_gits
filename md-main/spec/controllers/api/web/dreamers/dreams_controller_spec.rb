...
RSpec.describe Api::Web::Dreamers::DreamsController, type: :controller do
  ...
  describe 'GET #index' do
    ...
    context 'get filtered dreams' do
      ...
      before do
        fulfilled_dream
        another_dream
        get :index, dreamer_id: dreamer.id, fulfilled: true
      end
    ...
    context 'when get dreams ordered by launches count' do
      ...
      before do
        dream_with_launches
        get :index, dreamer_id: dreamer.id, launches: true
      end
