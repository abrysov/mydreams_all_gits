...
RSpec.describe Api::Web::Feed::UpdatesController, type: :controller do
  ...
  describe 'GET #index' do
    context 'get notification about certificate for dream' do
      before do
        @certif_notif = create :notification_with_certificate
        sign_in @certif_notif.dreamer
        get :index
      end
    ...
    context 'get notification about create dream' do
      before do
        @certif_notif = create :notification_with_dream
        sign_in @certif_notif.dreamer
        get :index
      end
    ...
    context 'get notification about deleted dreamer' do
      before do
        @dreamer_notif = create :notification_with_deleted_dreamer
        sign_in @dreamer_notif.dreamer
        get :index
      end
