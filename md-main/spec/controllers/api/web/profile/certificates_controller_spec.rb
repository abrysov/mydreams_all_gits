...
RSpec.describe Api::Web::Profile::CertificatesController, type: :controller do
  ...
  describe 'GET #index' do
    ...
    context 'when get certificates ordered by launches count(status)' do
      before { get :index, launches: true }
