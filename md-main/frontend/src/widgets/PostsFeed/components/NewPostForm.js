...
export default class NewPostForm extends React.Component {
  ...
  render() {
    ...
    const url = Routes.d_path(currentUser.get('id'));

    return (
      <div className="content-items create-record">
        <div className="row">
          <div className="avatar-col">
            <a className="avatar size-m" href={url}>
              <img alt="" src={currentUser.get('avatar/small')} />
            </a>
          </div>
          <div className="textarea-col">
            <div className="textarea-wrapper">
              <textarea ref="content" placeholder="Что нового?"></textarea>
        ...
        <div className="actions">
          <button className="blue accent" onClick={this.onSubmit.bind(this)}>Добавить запись</button>
        </div>
      </div>
    );
  }
