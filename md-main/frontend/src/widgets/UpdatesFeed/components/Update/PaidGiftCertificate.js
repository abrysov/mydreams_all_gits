...
export default class extends React.Component {
  render() {
    ...
    const dream = certificate.certifiable;
        ...
        <div className="row">
          ...
          <div className="info-col">
            <div className="username-row">
              <a href={initiator.url}>{initiator.full_name}</a>
              <span className="action-type">Подарил марку другу</span>
            </div>
        ...
        <div className="update-content new-dream">
          <div className="dream-wrapper">
            ...
            <div className="user-card">
              <DreamerAvatar dreamer={dream.dreamer} size="xs" />
              <div className="description">
                <a href={dream.dreamer.url} className="username">{dream.dreamer.full_name}</a>
              </div>
            </div>
          </div>
          <div className="description">
