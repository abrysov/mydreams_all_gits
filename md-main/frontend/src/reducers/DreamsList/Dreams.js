...
export default handleActions({
  [Constants.DREAMS_LIST.LOAD_DREAMS_START]: (state: State, action) => {
    return state.set('isLoadStarted', true);
  },
  [Constants.DREAMS_LIST.LOAD_DREAMS_FAILED]: (state: State, action) => {
    return state.set('isLoadStarted', false);
  },

  [Constants.DREAMS_LIST.LOAD_DREAMS_SUCCESS]: (state: State, action) => {
  ...
  [Constants.DREAMS_LIST.LOAD_NEXT_DREAMS_SUCCESS]: (state: State, action) => {
  ...
  [Constants.DREAMS_LIST.LIKE_CLICK_START]: (state: State, action) => {
    return state.set('isLikeProcessing', true);
  },
  [Constants.DREAMS_LIST.LIKE_CLICK_FAILED]: (state: State, action) => {
    return state.set('isLikeProcessing', false);
  },
  [Constants.DREAMS_LIST.LIKE_CLICK_SUCCESS]: (state: State, action) => {
  ...
  [Constants.DREAMS_LIST.UNLIKE_CLICK_START]: (state: State, action) => {
    return state.set('isLikeProcessing', true);
  },
  [Constants.DREAMS_LIST.UNLIKE_CLICK_FAILED]: (state: State, action) => {
    return state.set('isLikeProcessing', false);
  },
  [Constants.DREAMS_LIST.UNLIKE_CLICK_SUCCESS]: (state: State, action) => {
    const id = action.payload.dreamId;
    const index = state.dreams.findIndex((elem) => elem.get('id') === id);
  ...
  [Constants.CREATE_DREAM.ADD_DREAM_SUCCESS]: (state, action) => {
    const dream = Immutable.fromJS(action.payload);
    return state.update('dreams', (d) => d.unshift(dream));
  }
}, new State());
