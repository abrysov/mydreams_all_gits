...
@interface DreamCommentsViewController ()
@end


@implementation DreamCommentsViewController {
...
- (void)setupListViewController {
    ...
    [listViewController initWithRetreiver:^(Pager *pager, CommonListRetreiveCallbackBlock callback) {
        [ApiDataManager dreamcomments:self.dreamId pager:pager success:^(NSInteger total, NSArray<DreamComment> *items) {
...
- (void)alertView:(UIAlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex {
    ...
    switch (buttonIndex) {
        case 1:
        {
            ...
            [ApiDataManager dreampostcomment:self.dreamId text:self.commentTextView.text success:^{
