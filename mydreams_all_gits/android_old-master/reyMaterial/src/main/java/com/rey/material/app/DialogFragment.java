...
public class DialogFragment extends android.support.v4.app.DialogFragment{
    ...
    public static DialogFragment newInstance(Context context, Builder builder){
        DialogFragment fragment = new DialogFragment();
        fragment.mBuilder = builder;
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        Context context = mContext != null ? mContext : getActivity();
        com.rey.material.app.Dialog dialog = mBuilder == null ? new Dialog(context) : mBuilder.build(context);
