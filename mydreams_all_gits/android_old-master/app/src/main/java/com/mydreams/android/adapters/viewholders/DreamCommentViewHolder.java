...
public class DreamCommentViewHolder extends BaseViewHolder
{
	...
	private Action1<DreamCommentViewHolder> clickAction;
	private Action1<DreamCommentViewHolder> clickLikeAction;

	public DreamCommentViewHolder(@NonNull ViewGroup parent, @NonNull Action1<DreamCommentViewHolder> clickAction, @NonNull Action1<DreamCommentViewHolder> clickLikeAction)
	{
	...
	{
		setItem(((DreamCommentAdapter.CommentModel) item).getComment());
	}
