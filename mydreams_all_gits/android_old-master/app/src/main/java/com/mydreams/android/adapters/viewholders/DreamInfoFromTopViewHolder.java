...
public class DreamInfoFromTopViewHolder extends BaseViewHolder
{
	private final SimpleDateFormat dateFormat;
	private final int maxDreamPhoto;
	private final Action1<DreamInfoFromTopViewHolder> clickCommentAction;
	private final Action1<DreamInfoFromTopViewHolder> clickAction;
	...
	public DreamInfoFromTopViewHolder(@NonNull ViewGroup parent, @NonNull Action1<DreamInfoFromTopViewHolder> clickAction, @NonNull Action1<DreamInfoFromTopViewHolder> clickCommentAction)
	{
		super(R.layout.row_dream_info_from_top, parent);
