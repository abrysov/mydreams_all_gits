...
public class FlybookDreamDoneFragment extends BaseFlybookDreamFragment
{
	public static FlybookDreamDoneFragment getInstance(UserInfo user, @Nullable @StyleRes Integer theme)
	{
		...
		FlybookDreamDoneFragment result = new FlybookDreamDoneFragment();
	...
	protected void handleDreamTotal(final int dreamTotal)
	{
		...
		fragment.setDreamDoneCount(dreamTotal);
	}
	...
	{
		return RequestFactory.getUserFlybookList(userId, page, dreamPageSize, false, true);
	}
}
