...
public class SimpleActivityViewHolder extends BaseViewHolder
{
	...
	public SimpleActivityViewHolder(final ViewGroup parent, final Action1<Integer> clickUser)
	{
		super(R.layout.row_simple_activity, parent);
