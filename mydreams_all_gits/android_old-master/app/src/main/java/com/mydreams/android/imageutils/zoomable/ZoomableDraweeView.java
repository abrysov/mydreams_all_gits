		...
		implements ZoomableController.Listener
{
	...
	@Nullable
	private ZoomableController.Listener mZoomListener;
	...
	public void onTransformChanged(Matrix transform)
	{
		...
		if (mZoomListener != null)
			mZoomListener.onTransformChanged(transform);
	}
	...
	{
		return mZoomableController.getScaleFactor();
	}
	...
	public void setZoomChangeListener(@Nullable ZoomableController.Listener zoomListener)
	{
