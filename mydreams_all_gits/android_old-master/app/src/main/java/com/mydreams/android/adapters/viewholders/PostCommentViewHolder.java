...
public class PostCommentViewHolder extends BaseViewHolder
{
	...
	@Bind(R.id.lblComment)
	TextView lblComment;

	@Bind(R.id.btnLike)
	View btnLike;

	private Action1<PostCommentViewHolder> clickAction;
	private Action1<PostCommentViewHolder> clickLikeAction;

	public PostCommentViewHolder(@NonNull ViewGroup parent, @NonNull Action1<PostCommentViewHolder> clickAction, @NonNull Action1<PostCommentViewHolder> clickLikeAction)
	{
		super(R.layout.row_dream_comment, parent);
	...
	{
		setItem(((PostCommentAdapter.CommentModel) item).getComment());
	}
	...
	void onClickLike()
	{
		clickLikeAction.invoke(this);
	}

	public void setItem(@NonNull Comment item)
	{
		...
		lblComment.setText(item.getText());
		btnLike.setSelected(item.isliked());
	}
}
