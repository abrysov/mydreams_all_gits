...
public class DreamLaunchViewHolder extends BaseViewHolder
{
	...
	private Action1<DreamLaunchViewHolder> clickAction;

	public DreamLaunchViewHolder(@NonNull ViewGroup parent, @NonNull Action1<DreamLaunchViewHolder> clickAction)
	{
	...
	{
		setItem(((DreamLaunchAdapter.LaunchModel) item).getLaunch());
	}
	...
	public void setItem(@NonNull Launch item)
	{
